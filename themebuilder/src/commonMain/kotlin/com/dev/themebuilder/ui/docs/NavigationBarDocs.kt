...
import com.dev.korelibrary.components.navigationBar.NavigationBarDefaults
...
fun AppBottomNavigation() {
    ...
    val navItems = listOf(
        NavigationItem("Home", PhIcons.Regular.House, "home"),
        NavigationItem("Search", PhIcons.Regular.MagnifyingGlass, "search"),
        NavigationItem("Settings", PhIcons.Regular.Gear, "settings")
    )
            ...
            content = {
                ...
                NavigationBar(modifier = Modifier.fillMaxWidth()) {
                    ...
                    NavigationBarItem(
                        ...
                        icon = { 
                            Icon(imageVector = PhIcons.Regular.MagnifyingGlass, contentDescription = "Search")
                        },
                        label = { 
                            Text("Search") 
                        }
                    ...
                    NavigationBarItem(
                        ...
                        icon = { 
                            Icon(imageVector = PhIcons.Regular.Gear, contentDescription = "Settings")
                        },
                        label = { 
                            Text("Settings") 
                        }
